 ...
 *   ft4_decode_frame(iwave, nfa=200, nfb=2900, ndepth=3, mycall="", hiscall="",
 *                    nqso_progress=0, nfqso=0, lapcqonly=0, out, MAXOUT)
 *
...
int main(void) {
    ...
    int ndec = ft4_decode_frame(iwave, 200, 2900, 3, "", "", 0, 0,
                                /*lapcqonly*/0, out, MAXOUT);
