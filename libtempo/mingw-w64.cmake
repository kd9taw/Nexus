# CMake toolchain file: cross-compile libtempo (Fortran + C + C++ + FFTW3f) from a
# Linux host to Windows x86_64 using the MinGW-w64 GNU toolchain.
#
# Usage:
#   cmake -S libtempo -B libtempo/build-win \
#         -DCMAKE_TOOLCHAIN_FILE=$PWD/libtempo/mingw-w64.cmake \
...
# whole stack (libtempo, gfortran runtime, Rust linker) agrees on one thread model.
...
# libtempo.dll is a DLL by design and is unaffected. FFTW3f is already static, so
