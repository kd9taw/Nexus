...
! WSJT-X's Qt-side program-argument module (shm_key/exe_dir/data_dir) and is not
! vendored. The import here was ALREADY UNUSED upstream — the three names appear
! only in that trailing comment, nowhere in the body — so this is a pure import
! removal with no behavioural change. Same treatment as ft8b/fst4_decode/q65.
  use packjt
  use jt65_mod
