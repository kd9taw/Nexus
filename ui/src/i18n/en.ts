...
export const EN = {
  ...
  "remote.loggingHint": "Manual entries use the station’s general logbook. Field Day and QSO audio recording require local logging in this preview.",
  ...
  "remote.fieldDayTooLarge": "This event exceeds the Remote preview display limit. View the complete event in Nexus.",
  ...
  "remote.recallObserver": "Look up prior contacts. Remote QSO entry is not connected yet.",
  ...
  "remote.applicationUnavailable": "Station data unavailable. Check that Nexus is running and Remote observation is enabled at the shack.",
  "remote.desktopUpdateRequired": "This Nexus installer supports the station monitor. Install the updated Remote pilot at the shack to open the Nexus workspace here.",
  ...
  "remote.disabled": "Remote observation is disabled",
  ...
  "remote.restartHint": "For this pilot, enable Remote observation locally after each Nexus restart.",
  "remote.disable": "Disable Remote observation",
  "remote.enable": "Enable Remote observation",
