...
export const EN = {
  ...
  "remote.selfSpot": "Spot me",
  "remote.selfSpotConfirm.title": "Post a public DX cluster spot?",
  "remote.selfSpotConfirm.body": "{{reference}} on {{freq}} MHz, from the station’s own call and cluster login. Everyone on the cluster sees it.",
  "remote.selfSpotConfirm.post": "Post spot",
  "remote.selfSpotPosted": "Spot sent to the station’s DX cluster.",
  "remote.selfSpotNoCluster": "The station has no DX cluster connected, so nothing was posted.",
