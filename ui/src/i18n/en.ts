...
export const EN = {
  ...
  "remote.trialRunning": "Trial access is running. Days remaining: {{days}}.",
  "remote.trialUnknownStart": "Trial access is running. This account predates the trial clock, so its start date is not recorded.",
  "remote.trialEnded": "The fourteen days are over. Nothing at your station has changed — Nexus on your PC is unaffected.",
