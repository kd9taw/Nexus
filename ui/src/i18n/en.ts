...
export const EN = {
  ...
  "remote.loggingLocalHint": "Remote logging requires a separate permission for each browser after Nexus restarts. Logging never grants radio or transmit control.",
  ...
  "remote.controlLocalHint": "Allow station controls for each browser after Nexus restarts. This permission covers supported receiver, radio and amplifier controls. Transmitting requires its own permission.",
  "remote.transmitAllow": "Allow FT8/FT4 transmission",
  "remote.transmitRevoke": "Revoke transmission permission",
  "remote.transmitLocalHint": "FT8/FT4 transmission requires station control and this separate permission after each Nexus restart. Revoking it stops the browser’s transmission.",
  ...
  "remote.restartHint": "Remote turns off whenever Nexus restarts. Turn it on again here after each restart.",
