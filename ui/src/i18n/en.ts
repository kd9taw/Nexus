...
export const EN = {
  ...
  "remote.signUpHint": "New here? After you create an account, check your email and click the confirmation link. Then come back to this page and sign in.",
  ...
  "remote.confirmEmailBody": "Your sign-up worked. We sent a confirmation link to the email address you signed up with. Open that email, click the link, then come back here and continue. If you land back on this page, the email is not confirmed yet.",
  "remote.confirmEmailSpam": "Nothing after a few minutes? Check your spam or junk folder for an email from Nexus Remote. The link works for five days.",
