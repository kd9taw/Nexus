...
export const EN = {
  ...
  "remote.loggingUnavailable": "Remote logging and logbook history are not connected yet.",
  "remote.voiceKeyerUnavailable": "Remote audio and voice-keyer recordings and playback are not connected yet.",
  "remote.spotsUnavailable": "Remote spots and needed-status data are not connected yet.",
