...
export const EN = {
  ...
  "remote.pilotIntro": "Observe your radio and amplifier from an approved browser. This pilot provides status readings only.",
  ...
  "remote.trialRequired": "Your account is ready. Ask the pilot administrator to activate trial access using this account ID.",
