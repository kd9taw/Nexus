...
export const EN = {
  ...
  "remote.loggingLocalHint": "Remote logging needs a separate permission for each browser. It is kept when Nexus restarts, for as long as that browser stays approved. Logging never grants radio or transmit control.",
  ...
  "remote.controlLocalHint": "Allow station controls for each browser. This permission covers supported receiver, radio and amplifier controls, and it is kept when Nexus restarts for as long as that browser stays approved. Transmitting requires its own permission.",
  "remote.transmitAllow": "Allow FT8/FT4 transmission",
  "remote.transmitRevoke": "Revoke transmission permission",
  "remote.transmitLocalHint": "FT8/FT4 transmission requires station control and this separate permission. It resets whenever Nexus restarts: grant it again here after every restart. Revoking it stops the browser’s transmission.",
  ...
  "remote.ftControlPreview": "Station controls and logging require local permission. FT8/FT4 transmission also needs separate transmit permission in Nexus.",
  ...
  "remote.loggingPermissionRequired": "Allow remote logging for this browser in Nexus at the station.",
  ...
  "remote.nativeIntro": "Pair this station with your Remote account, then approve each browser here. While Remote is on, approved browsers receive your station, contact, radio and amplifier data.",
  ...
  "remote.restartHint": "Remote stays on when Nexus restarts: if it was on when Nexus closed, it turns itself back on and reconnects. FT8/FT4 transmit permission is not kept, so grant it again after every restart.",
