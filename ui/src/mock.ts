      ...
      workableNow: [
        {
          ...
          howToCall: 'Enable Hound mode; call 1000–4000 Hz', windowHint: 'open now', priority: 462,
        },
        {
          call: 'C91RU', entity: 'Mozambique', need: 'Atno', band: '20m',
          bearingDeg: 95, octant: 'E', distanceKm: 13800, status: 'WorkNow',
          likelihood: 'Fair', likelihoodScore: 0.41, liveConfirmed: true,
          howToCall: 'Enable Hound mode; call 1000–4000 Hz', windowHint: 'open now — live spots', priority: 450,
        },
      ],
      active: ['C91RU'],
      upcoming: [
