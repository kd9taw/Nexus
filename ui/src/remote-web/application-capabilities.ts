...
import { DXPEDITIONS_COMMAND, INSIGHTS_COMMAND, QUERY_COMMAND, RECALL_COMMAND } from './application-query-protocol'

export const APPLICATION_VERSIONS = [1, 2, 3, 4, 5, 6, 7] as const
/** Query grammar revisions are independent of instrument-stream revisions. */
export const applicationQueryVersion = (version: number): 3 | 4 | 6 | 7 => version >= 7 ? 7 : version >= 6 ? 6 : version >= 4 ? 4 : 3
