...
export function controlVersion(action: StationAction): 2 | 3 | 4 {
  ...
  return ['radio.level', 'radio.band', 'radio.filterWidth', 'radio.function', 'radio.agc', 'radio.phoneMode', 'radio.workSpot', 'radio.workDigitalSpot', 'radio.repeater', 'radio.memoryRecall', 'radio.aprsTune', 'rotator.point', 'rotator.pointAtCall', 'rotator.stop','radio.frequency', 'radio.mode', 'radio.tier', 'radio.workspace', 'radio.select', 'amplifier.followBand', 'decoder.js8Speed', 'decoder.msk144Period', 'decoder.depth', 'receiver.rxOffset', 'receiver.rxGain', 'decoder.aiCw', 'decoder.redecode', 'radio.split', 'radio.xit', 'radio.vfo', 'radio.rit'].includes(action.action) ? 3 : 2
}
