                  ...
                  ? request.headers.get('x-nexus-application-memories-version') === '1'
                    ? request.headers.get('x-nexus-application-ota-version') === '1'
                      ? request.headers.get('x-nexus-application-field-day-version') === '1'
                        ? request.headers.get('x-nexus-application-js8-version') === '1' ? request.headers.get('x-nexus-application-station-modes-version') === '1' ? request.headers.get('x-nexus-application-navigation-version') === '1' ? request.headers.get('x-nexus-application-configuration-version') === '1' ? request.headers.get('x-nexus-application-lookups-version') === '1' ? request.headers.get('x-nexus-application-alerts-version') === '1' ? 16 : 15 : 14 : 13 : 12 : 11 : 10 : 9 : 8 : 7 : 6
                : 5
              : 4
            : 3
