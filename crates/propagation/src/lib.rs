...
pub use needalert::{
    ...
    rank as rank_needs, skimmer_grid, strip_confirm_tier, vhf_max_terrestrial_km,
    workable_by_getting_out, Heard, HuntedActivations, NeedAlert, NeedTag, ParkRef, VHF_MIN_DX_KM,
};
pub use opening::{
