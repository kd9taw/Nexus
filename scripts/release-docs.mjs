...
const SHOTS = {
  // Settings reference. Every figure is a crop of a SettingsPanel fieldset, so the panel
  // and the registry that decides which fieldsets exist are what can date one of them.
  'settings-tabs.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-operator-at-key.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-setup-health.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-radios.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-radio-routing.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-rig-cat.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-audio.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-receive-audio.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-satellite-doppler.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-orbital-elements.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-rotator.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-amplifier.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-transmit-limits.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-phone.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-cw.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-digital.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-station-housekeeping.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-station-power-units.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-beacons.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-q65.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-rtty.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-psk.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-sstv.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-aprs-rf.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-aprs-internet.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-working-frequencies.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-pounce.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-alerts.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-connections.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-local-apis.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-spot-sources.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-dxkeeper.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-n3fjp.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-confirmations-lotw.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-confirmations-qrz.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-confirmations-wrl.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-confirmations-cloudlog.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-contest-category.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-whos-who.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-field-day-club-sync.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-workspace.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-connect-tv.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-features.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-accessibility.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
  'settings-backup-reset.webp': ['ui/src/components/SettingsPanel.tsx', 'ui/src/settings/registry.ts'],
