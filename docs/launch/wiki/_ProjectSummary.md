...
> to end on Yaesu FTDX10 and FT-991A and on native-CI-V Icom. APRS is on the air
...
> hardware here. The TempoFast and TempoDeep sensitivity figures are still bench
> numbers. The installer is unsigned, so verify the published SHA-256.
