...
**Full docs on GitHub:**
<https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs>
...
| Guide | What it covers |
|---|---|
| [Needed — DX on the air now](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/needed-dx.md) | Every station ranked by value to *your* log, each row carrying the evidence |
| [DXpeditions](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/dxpeditions.md) | Active and upcoming expeditions, your modelled best window per day, wake-me alarms |
| [Logbook & QSL](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/logbook-qsl.md) | The ADIF logbook, confirmation sources, and the LoTW / QRZ / ClubLog / eQSL / HRDLog connectors |
| [Awards & Journey](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/awards-journey.md) | Offline DXCC / Challenge / Honor Roll / WAS / WAZ, plus the local-only Journey layer |

### Propagation & satellites

| Guide | What it covers |
|---|---|
| [Connect — map + propagation](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/connect.md) | The shaded 3-D globe, greyline, live spots, aurora, MUF, moving satellites, the opening detector, and the assignable pane grid |
| [Satellites](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/satellites.md) | Pass predictions for your grid, favorites, polar plots, frequencies, and rotor auto-track |

### Contesting & portable

| Guide | What it covers |
|---|---|
| [Contesting, POTA & SOTA](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/contesting-pota.md) | ARRL / Winter Field Day with Cabrillo and club interop, plus the POTA / SOTA hunter |

### System

| Guide | What it covers |
|---|---|
| [Settings reference](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/guide/settings-reference.md) | A walk through every Settings tab, field by field |
...
- [Interop & companion setup](https://sourceforge.net/p/nexus-ham-radio/code/ci/main/tree/docs/interop.md)
