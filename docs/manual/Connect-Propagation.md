...
| DX cluster (human spots) | two nodes chosen from eight built in, or your own list | Exact-frequency human-posted spots including SSB/phone; 200-spot buffer; nodes configurable |
...
| Cluster/RBN | Enabled; two cluster nodes chosen automatically from eight built in; RBN CW/digital feeds auto-wired |
