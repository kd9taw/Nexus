...
| 17 m  | **18.1015** | QRP CW 18.096, just above FT8 18.100 | cramped — TempoDeep (50 Hz) fits best |
| 15 m  | **21.0905** | cluster 21.074–21.078, WSPR 21.0946 | |
| 12 m  | **24.9165** | SKCC 24.910, ~3 kHz above FT8 24.915 | tight — TempoDeep recommended |
...
- **Cramped bands.** On 17 m and 12 m the usable gap is only a few kHz, so TempoDeep's ~50 Hz signal fits better than a ~150 Hz TempoFast signal there.
