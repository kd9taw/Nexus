...
- **Propagation:** <!-- NVIS / regional groundwave / DX; SFI/K if you know it -->

## Result

- **Did it decode?** <!-- yes / no / intermittent -->
...
<!-- Free text: what went well, what failed, anything surprising. Be specific —
this is the part that drives the roadmap. -->

## Logs / screenshots / audio

<!-- Optional but very helpful: waterfall screenshots, the decode feed, an ADIF
snippet, or a short audio/WAV clip of the received signal. -->
